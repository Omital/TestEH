...
using TestEH.Sessions;
using TestEH.Web.Controllers.Results;
using TestEH.Web.Models;
using TestEH.Web.Models.Account;
...
{
    public class AccountController : TestEHControllerBase
    {
